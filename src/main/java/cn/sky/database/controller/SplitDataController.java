...
public class SplitDataController {
    ...
    public static void main(String[] args) {
        ...
        if (null == args || args.length != 3) {
            System.err.println("sorry: the SplitData Method need 3 arguments.");
            return;
        }
        ...
        try {
            ...
            System.out.println("SplitData Method has started...");
    ...
    private static void usage() {
        System.out.println();
        System.out.println("-----------SplitData Method usage------------");
